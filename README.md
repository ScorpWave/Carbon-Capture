# Carbon-Capture
This project analyzes CO₂ data in the Bangchak refinery in Bangkok from September 2025 to March 2026 based on pilot scale.  The dataset, sourced from PLC machine(Sample Raw Data), and Data Summary, was cleaned and merged into a single table to track key performance indicators like CO₂ Capture, CO₂ Recovery, CO₂ Capture Efficiency, and CO₂ Recovery Efficiency. The standard mandates that CO₂ Capture Efficiency and CO₂ Recovery Efficiency should be 99%+ and 95%+ respectively. 
